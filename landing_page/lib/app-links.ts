 ...
 *
 * In development the main PillMate app runs on port 3001 while the
 * landing page runs on port 3000 (npm run dev).
 * In production, replace PILLMATE_APP_URL with your deployed domain.
 */
export const PILLMATE_APP_URL =
  process.env.NEXT_PUBLIC_PILLMATE_APP_URL ?? "http://localhost:3001";
